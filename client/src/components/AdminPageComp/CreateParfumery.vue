    ...
    <div class="container mb-5">
        ...
        <form @submit="addProduct" enctype="multipart/form-data">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    <label for="fragranceformat"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Fragrance Format</label>
                    <input type="tel" id="fragranceformat" v-model="product.fragranceformat"
                        placeholder="fragranceformat"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        required="">
                </div>
                ...
                <div>
                    <label for="fragrancescent"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Fragrance Scent</label>
                ...
                <div>
                    <label for="for" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Fragrance
                        Material Features</label>
                    <input type="tel" id="fragrancematerialfeatures" v-model="product.fragrancematerialfeatures"
                        placeholder="fragrancematerialfeatures"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        required="">
                </div>
                ...
                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="description" rows="3"
            ...
            <div class="mb-6">
                ...
                <textarea class=" form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0
                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="information" rows="3"
