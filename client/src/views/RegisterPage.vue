                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <vee-form class="space-y-4 md:space-y-6" @submit.prevent()="register" :validation-schema="schema"> 
                        ...
                        <div>
                            ...
                            <vee-field type="email" name="email" id="email" v-model="registering_user.email"
                        ...
                        <div>
                            ...
                            <vee-field type="password" name="password" id="password" placeholder="••••••••" v-model="registering_user.password" :bails= false
                        ...
                        <!-- Confirm Section -->
                        <div>
                            <label for="confirm" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Confirm</label>
                            <vee-field type="password" name="confirm" id="confirm" v-model="registering_user.cofirm_password"
                                placeholder="••••••••"
