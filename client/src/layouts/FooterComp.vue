<template>
        ...
        <div class="container my-5">
            ...
            <footer class="text-black text-center text-lg-start" style="background-color: rgb(227, 191, 219);">
                <!-- Grid container -->
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                            ...
                            <ul class="fa-ul" style="margin-left: 1.65em;">
                                <li class="mb-3">
                                    <span class="fa-li"><i class="fas fa-home"></i></span><span class="ms-2">Moscow,
                                        Ramenskoe Krimskoe 1 , RU</span>
                                </li>
                                <li class="mb-3">
